...
LC_WQ4$Date<- LC_WQ4$Date - 8*60*60
...
```{r r_var3, include= FALSE}
phos4 <-
  ggplot(data= site4, aes(x= Date)) +
  ggtitle("Phosphorus") +
...
var4 <-
  ...
  geom_point(data= LC_WQ4, aes(y= Temperature), color= "red", size=.5) +
  geom_point(data= LC_WQ4,aes(y= Salinity), color= "black", size=.5) +
...
var4<- ggplotly(var4)
#cond4<- ggplotly(cond4)
#color4<- ggplotly(color4)
#secchi4<- ggplotly(secchi4)
#chloro4<- ggplotly(chloro4)
#nitro4<- ggplotly(nitro4)
#phos4<- ggplotly(phos4)
```
...
par(new=TRUE)
plot(site4$Date, site4$Phosphorus, pch=19, ylab="Phosphorus (µg/L)", xlab="Date", main="Phosphorus", ylim=c(0,125),format="%m-%Y",las=1, cex=2)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site4$Date, site4$Nitrogen, pch=19, ylab="Nitrogen (µg/L)", xlab="Date", main="Nitrogen", ylim=c(0,1300),format="%m-%Y",las=1, cex=2)
#polygon(xx,yy,col="cornflowerblue", border=NA)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site4$Date, site4$Chlorophyll, pch=19, ylab="Chlorophyll (µg/L)", xlab="Date", main="Chlorophyll ", ylim=c(0,65),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site4$Date, site4$Secchi, pch=19, ylab="Secchi (m)", xlab="Date", main="Secchi", ylim=c(0,2),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site4$Date, site4$Color, pch=19, ylab="Color (Pt-Co Units)", xlab="Date", main="Color", ylim=c(0,110),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site4$Date, site4$Conductivity, pch=19, ylab="Conductivity (mS/cm))", xlab="Date", main="Conductivity", ylim=c(0,40),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
