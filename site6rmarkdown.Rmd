...
LC_WQ6$Date<- LC_WQ6$Date - 8*60*60
...
```{r r_var6, include= FALSE}

phos6 <-
  ggplot(data= site6, aes(x= Date)) +
  ggtitle("Phosphorus") +
...
var6 <-
  ...
  geom_point(data= LC_WQ6, aes(y= Temperature), color= "red", size=.5) +
  geom_point(data= LC_WQ6,aes(y= Salinity), color= "black", size=.5) +
...
var6<- ggplotly(var6)
#cond6<- ggplotly(cond6)
#color6<- ggplotly(color6)
#secchi6<- ggplotly(secchi6)
#chloro6<- ggplotly(chloro6)
#nitro6<- ggplotly(nitro6)
#phos6<- ggplotly(phos6)
```
...
par(new=TRUE)
plot(site6$Date, site6$Phosphorus, pch=19, ylab="Phosphorus (µg/L)", xlab="Date", main="Phosphorus", ylim=c(0,125),format="%m-%Y",las=1, cex=2)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site6$Date, site6$Nitrogen, pch=19, ylab="Nitrogen (µg/L)", xlab="Date", main="Nitrogen", ylim=c(0,1300),format="%m-%Y",las=1, cex=2)
#polygon(xx,yy,col="cornflowerblue", border=NA)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site6$Date, site6$Chlorophyll, pch=19, ylab="Chlorophyll (µg/L)", xlab="Date", main="Chlorophyll ", ylim=c(0,65),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site6$Date, site6$Secchi, pch=19, ylab="Secchi (m)", xlab="Date", main="Secchi", ylim=c(0,2),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site6$Date, site6$Color, pch=19, ylab="Color (Pt-Co Units)", xlab="Date", main="Color", ylim=c(0,110),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site6$Date, site6$Conductivity, pch=19, ylab="Conductivity (mS/cm))", xlab="Date", main="Conductivity", ylim=c(0,40),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
