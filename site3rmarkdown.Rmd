...
LC_WQ3$Date<- LC_WQ3$Date + 4*60*60
...
var3 <-
  ...
  geom_point(data= LC_WQ3, aes(y= Temperature), color= "red", size=.5) +
  geom_point(data= LC_WQ3,aes(y= Salinity), color= "black", size=.5) +
...
var3<- ggplotly(var3)
#cond3<- ggplotly(cond3)
#color3<- ggplotly(color3)
#secchi3<- ggplotly(secchi3)
#chloro3<- ggplotly(chloro3)
#nitro3<- ggplotly(nitro3)
#phos3<- ggplotly(phos3)
```
...
par(new=TRUE)
plot(site3$Date, site3$Phosphorus, pch=19, ylab="Phosphorus (µg/L)", xlab="Date", main="Phosphorus", ylim=c(0,125),format="%m-%Y",las=1, cex=2)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site3$Date, site3$Nitrogen, pch=19, ylab="Nitrogen (µg/L)", xlab="Date", main="Nitrogen", ylim=c(0,1300),format="%m-%Y",las=1, cex=2)
#polygon(xx,yy,col="cornflowerblue", border=NA)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site3$Date, site3$Chlorophyll, pch=19, ylab="Chlorophyll (µg/L)", xlab="Date", main="Chlorophyll ", ylim=c(0,65),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site3$Date, site3$Secchi, pch=19, ylab="Secchi (m)", xlab="Date", main="Secchi", ylim=c(0,2),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site3$Date, site3$Color, pch=19, ylab="Color (Pt-Co Units)", xlab="Date", main="Color", ylim=c(0,110),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site3$Date, site3$Conductivity, pch=19, ylab="Conductivity (mS/cm))", xlab="Date", main="Conductivity", ylim=c(0,40),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
