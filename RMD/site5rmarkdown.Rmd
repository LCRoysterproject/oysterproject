...
LC_WQ5$Date<- LC_WQ5$Date - 8*60*60
...
var5 <-
  ...
  geom_point(data= LC_WQ5, aes(y= Temperature), color= "red", size=.5) +
  geom_point(data= LC_WQ5,aes(y= Salinity), color= "black", size=.5) +
...
var5<- ggplotly(var5)
#cond5<- ggplotly(cond5)
#color5<- ggplotly(color5)
#secchi5<- ggplotly(secchi5)
#chloro5<- ggplotly(chloro5)
#nitro5<- ggplotly(nitro5)
#phos5<- ggplotly(phos5)
```
...
par(new=TRUE)
plot(site5$Date, site5$Phosphorus, pch=19, ylab="Phosphorus (µg/L)", xlab="Date", main="Phosphorus", ylim=c(0,125),format="%m-%Y",las=1, cex=2)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site5$Date, site5$Nitrogen, pch=19, ylab="Nitrogen (µg/L)", xlab="Date", main="Nitrogen", ylim=c(0,1300),format="%m-%Y",las=1, cex=2)
#polygon(xx,yy,col="cornflowerblue", border=NA)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site5$Date, site5$Chlorophyll, pch=19, ylab="Chlorophyll (µg/L)", xlab="Date", main="Chlorophyll ", ylim=c(0,65),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site5$Date, site5$Secchi, pch=19, ylab="Secchi (m)", xlab="Date", main="Secchi", ylim=c(0,2),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site5$Date, site5$Color, pch=19, ylab="Color (Pt-Co Units)", xlab="Date", main="Color", ylim=c(0,110),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
...
axis(4, at=pretty(c(0,40000)), col='black')
par(new=TRUE)
plot(site5$Date, site5$Conductivity, pch=19, ylab="Conductivity (mS/cm))", xlab="Date", main="Conductivity", ylim=c(0,40),format="%m-%Y",las=1, cex=2)
mtext("River Discharge ( cfs)", side = 4,cex=0.6)
